        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              />
              <span className="text-2xl font-bold">Ikell</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#steps" className="text-gray-400 hover:text-white transition-colors">Características</a></li>
              <li><a href="#quicksetup" className="text-gray-400 hover:text-white transition-colors">Dashboard</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2024 Ikell. Todos los derechos reservados.
            </p>
